...
export function homeSEOBody() {
  return `<div class="seo-prerender">
    <header><a class="seo-brand" href="/">${escapeHTML(seoConfig.site.name)}</a><nav aria-label="Primary"><a href="/topics">Topics</a><a href="/companies">Companies</a><a href="/investors">Investors</a><a href="/people">People</a><a href="/concepts">Concepts</a><a href="/sources">Evidence</a></nav></header>
    <main>
