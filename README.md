...
截至 2026-07-14，vault 里已经沉淀：

| 类型 | 数量 | 说明 |
| --- | ---: | --- |
| 公司/产品 | 87 | AI 应用、企业 Agent、browser/agent infra、垂直 AI、开发者工具等 |
| 投资人/投资机构 | 84 | VC、战略投资方、天使投资人、创业者投资人 |
| 人物 | 118 | 创始人、CEO、投资人、记者、关键 operator |
| 持续触点 | 247 | 官网、博客、X、LinkedIn、Product Hunt、GitHub、文档、媒体页等 |
...
![Oh My AI Company homepage](assets/readme/oh-my-ai-company-home.png)
...
| `AI Investor` | AI 投资机构与投资人。用于监控新基金、投资公告、赛道 thesis 和 portfolio 动向。 | https://x.com/i/lists/2076849418670837886 |
